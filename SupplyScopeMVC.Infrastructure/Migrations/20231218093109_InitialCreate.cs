...
namespace SupplyScopeMVC.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContactDetails_Recipients_RecipientId",
                        column: x => x.RecipientId,
                        principalTable: "Recipients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "RecipientContactInformations",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    RecipientRef = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipientContactInformations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RecipientContactInformations_Recipients_RecipientRef",
                        column: x => x.RecipientRef,
                        principalTable: "Recipients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactDetails_RecipientId",
                table: "ContactDetails",
                column: "RecipientId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipientContactInformations_RecipientRef",
                table: "RecipientContactInformations",
                column: "RecipientRef",
                unique: true);
        }
